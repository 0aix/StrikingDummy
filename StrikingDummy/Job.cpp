...
#define LV_SUB 400.0f
#define LV_DIV 1900.0f
#define LV_MAIN 390.0f
...
namespace StrikingDummy
{
	...
	void Stats::calculate_stats(float job_attr)
	{
		...
		attk_multiplier = floor(195.0f * (main_stat - LV_MAIN) / LV_MAIN + 100.0f) / 100.0f;
		pot_multiplier = (floor(195.0f * (pot_stat - LV_MAIN) / LV_MAIN + 100.0f) / 100.0f) / attk_multiplier;
